...
### 场景 2：代码审查
```
@C:\Users\tongyu\Documents\knowledge-base\AI协作\代码审查模板.md
请按照模板审查这段代码
```

### 场景 3：重构代码
```
@C:\Users\tongyu\Documents\knowledge-base\重构案例\2026-01-09-资金流服务重构.md
参考这个案例，重构当前代码
```

### 场景 4：生成文档
```
@C:\Users\tongyu\Documents\knowledge-base\AI协作\高效提示词模板.md
